...
const Item = ({ label, onClick, icon: Icon, documentIcon, active, expanded, isSearch, level= 0, onExpand, id }: ItemProps) => {
...
Item.Sketelon = function ItemSkeleton({ level }: { level?: number }) {
  return (
